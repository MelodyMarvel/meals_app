...
class MealItem extends StatelessWidget {
  ...
  final Meal meal;
  final void Function(BuildContext context, Meal mean) onSelectMeal;
  ...
  String get affordabilityText {
    return meal.complexity.name[0].toUpperCase() + meal.affordability.name.substring(1);
  }
